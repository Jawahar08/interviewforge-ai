...
|:----------:|------|:-------:|
| <img src="https://skillicons.dev/icons?i=nextjs" width="24" /> **Next.js** | App Router framework + Turbopack | `16` |
| <img src="https://skillicons.dev/icons?i=react" width="24" /> **React** | Component architecture | `19` |
| <img src="https://skillicons.dev/icons?i=ts" width="24" /> **TypeScript** | End-to-end type safety | `5` |
| <img src="https://skillicons.dev/icons?i=tailwind" width="24" /> **Tailwind CSS** | Utility-first responsive styling | `latest` |
...
| Technology | Role | Version |
|:----------:|------|:-------:|
| <img src="https://skillicons.dev/icons?i=java" width="24" /> **Java** | Core language | `23` |
| <img src="https://skillicons.dev/icons?i=spring" width="24" /> **Spring Boot** | REST API framework | `3.x` |
| 🛡️ **Spring Security** | Authentication & authorization | `—` |
| 🔑 **JWT (JJWT)** | Stateless token authentication | `—` |
| 🔐 **BCrypt** | Adaptive password hashing | `—` |
| <img src="https://skillicons.dev/icons?i=hibernate" width="24" /> **Hibernate/JPA** | ORM & database abstraction | `—` |
| <img src="https://skillicons.dev/icons?i=maven" width="24" /> **Maven** | Dependency management & build | `—` |
